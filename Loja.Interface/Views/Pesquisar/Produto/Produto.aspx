                    ...
                    <ul class="list-unstyled">
                        ...
                        <li class="nav-header"><a href="#" data-toggle="collapse" data-target="#menu2">
                            ...
                            <ul class="list-unstyled collapse in" id="Ul1">
                                <li><a href="../Departamento/Departamento.aspx">Departamento</a></li>
                                <li><a href="Produto.aspx">Produto Por Departamento</a></li>
                                        ...
                                        <div class="controls">
                                            ...
                                            <asp:GridView ID="gdvProdutos" runat="server" AutoGenerateColumns="False" DataSourceID="ODSProdutoGridView" CellPadding="4" ForeColor="#333333" Width="717px" AutoGenerateDeleteButton="True" AutoGenerateEditButton="True">
                                                ...
                                                <Columns>
                                                    ...
                                                    <asp:BoundField DataField="IdProdutoSimilar" HeaderText="ProdutoSimilar" SortExpression="IdProdutoSimilar">
                                            ...
                                            <asp:ObjectDataSource ID="ODSProdutoGridView" runat="server" OldValuesParameterFormatString="original_{0}" SelectMethod="DepartamentoPorProduto" TypeName="Loja.Fachada.Fachada.ProdutoFachada" InsertMethod="Insert">
                                                <InsertParameters>
                                                    <asp:Parameter Name="departamentoIdProduto" Type="Int32" />
                                                    <asp:Parameter Name="nomeProduto" Type="String" />
                                                    <asp:Parameter Name="precoProduto" Type="Double" />
                                                    <asp:Parameter Name="quantidadeProduto" Type="Int32" />
                                                    <asp:Parameter Name="idProdutoSimilar" Type="Int32" />
                                                </InsertParameters>
                                                <SelectParameters>
                                                    <asp:ControlParameter ControlID="ddlDepartamento" DefaultValue="" Name="id" PropertyName="SelectedValue" Type="Int32" />
                                                </SelectParameters>
                                            </asp:ObjectDataSource>
                                        </div>
                                    </div>
