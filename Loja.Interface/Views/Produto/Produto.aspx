                            ...
                            <div class="panel panel-default">
                                ...
                                <div class="panel-body">
                                    ...
                                    <div class="control-group col-md-6">
                                        ...
                                        <div class="controls">
                                            <asp:TextBox class="form-control" ID="txtBoxPreco" runat="server" Width="765px" onKeyUp="filtraNumerosComVirgula(this)" MaxLength="4"></asp:TextBox>
                                    ...
                                    <div class="control-group col-md-4">
                                        ...
                                        <div class="controls">
                                            <asp:DropDownList ID="ddlDepartamento" runat="server" DataSourceID="DepartamentoODS" DataTextField="NomeDepartamento" DataValueField="IdDepartamento" AutoPostBack="True">
                                            </asp:DropDownList>
                                        </div>
                                    </div>
                                    <div class="control-group col-md-4">
                                    ...
                                    <div class="control-group col-md-12">
                                        ...
                                        <div class="controls">
                                            ...
                                            <asp:ObjectDataSource ID="ProdutoODS" runat="server" OldValuesParameterFormatString="original_{0}" SelectMethod="listarProduto" TypeName="Loja.Fachada.Fachada.ProdutoFachada">
                                                <SelectParameters>
                                                    <asp:Parameter DefaultValue="-1" Name="idProduto" Type="Int32" />
                                                </SelectParameters>
